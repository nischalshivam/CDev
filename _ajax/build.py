#!/usr/bin/env python3
"""build.py — assemble the Ajax sample (defence niche, ~3 min = beats 0-32).
...
BODY_END = 190.8       # end of beat 32 ("They were shaking... Really loud.") — act one
STYLE = "defence"
ST = BC.style(STYLE)
...
OV = {
# Distinct query per beat — near-identical phrasings are what let one asset win four beats in the
# first cars cut. Cards carry the two numbers this story turns on.
 0:  ("Ajax armoured fighting vehicle British Army driving", None, ""),
 1:  ("Ajax vehicle handover British Army ceremony", None, ""),
 2:  ("Ajax armoured vehicle development trials programme", None, ""),
 3:  ("Ministry of Defence Whitehall building London", None, ""),
 4:  ("House of Commons parliament defence debate", None, ""),
 5:  ("Ajax vehicle in service British Army squadron", None, ""),
 6:  ("crew inside armoured vehicle headsets stations", None, ""),
 7:  ("armoured vehicle halted stopped on exercise", None, ""),
 8:  ("Ajax vehicles parked hangar depot lined up", None, ""),
 9:  ("defence committee hearing witness table", None, ""),
 10: ("Ajax armoured reconnaissance vehicle close up hull", None, ""),
 11: ("British Army armoured vehicles convoy cross country", None, ""),
 12: (None, ("title", "2010", "the programme begins"), "whoosh"),
 13: ("CVRT Scimitar reconnaissance vehicle British Army", None, ""),
 14: ("old tracked armoured vehicle Scorpion Spartan Sultan", None, ""),
 15: ("modern battlefield armoured vehicle technology", None, ""),
 16: ("armoured vehicle armour protection sensors", None, ""),
 17: ("battlefield digital communications screens data link", None, ""),
 18: ("Ajax turret sensor mast optics", None, ""),
 19: ("reconnaissance vehicle surveillance observation", None, ""),
 20: ("40mm CT40 cased telescoped cannon turret", None, ""),
 21: ("Ares Athena Apollo Atlas Ajax family variants", None, ""),
 22: (None, ("stat", "589", "vehicles  ·  six variants"), "whoosh"),
 23: ("General Dynamics armoured vehicle factory assembly line", None, ""),
 24: (None, ("stat", "5.5 bn", "pounds  ·  design, build, support"), "whoosh"),
 25: ("British Army armoured vehicle fleet order", None, ""),
 26: ("government defence minister announcement podium", None, ""),
 27: ("Ajax firing test cannon range 2016", None, ""),
 28: ("armoured vehicle hulls production line welding", None, ""),
 29: ("Ajax vehicle trials test track mobility", None, ""),
 30: ("armoured vehicle programme delayed waiting", None, ""),
 31: ("Ajax armoured vehicle driving rough terrain", None, ""),
 32: ("armoured vehicle tracks vibration rough ride shaking", None, ""),
}
...
CARD_BG = [("0x39404a", "0x22272f", 0, 0, W, H),
           ("0x2c343d", "0x1a1e25", W, 0, 0, H),
           ("0x3d4149", "0x24282e", 0, H, W, 0)]
...
DENY = ("video game", "gameplay", "war thunder", "animation render", "cartoon")
# Terms that prove a clip really is a full-size truck, for beats that ask for one.
MIL = ("vehicle", "ajax", "armoured", "armored", "tank", "military", "army", "soldier",
       "turret", "track", "cannon", "scimitar", "boxer", "challenger", "crew")
...
STILLS_TARGET = 0.25   # measured from the reference channel (competitor cars = 44% stills)
_MIX = {"img": 0, "vid": 0}
SEEN_HASHES = []
...
def pick_query(c, q, used):
    ...
    r = BC.pick(c, q, used, seen_hashes=SEEN_HASHES, prefer=want, deny=DENY, require=MIL,
                   require_when=("vehicle", "armoured", "ajax", "tank", "military", "army"))
    if r[1]:
